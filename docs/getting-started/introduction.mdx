---
title: DoDocs
description: Turn Markdown files into a documentation website.
nav: 0
---

<Intro>
  A static documentation generator. Point it at a folder of Markdown and it builds the site, with a GitHub [reusable workflow](./github-actions.mdx) to publish it.
</Intro>
...
```sh
$ git clone https://github.com/thiagocajadev/do-docs.git
$ cd docs
$ pnpm install
```
...
| `NEXT_PUBLIC_LIBNAME_DOTSUFFIX_HREF`  | Href for the ".docs" suffix link inside the header                                                                                                                       | `https://github.com/acme/my-project`                                                                          |
...
| `NEXT_PUBLIC_LOCALE`                  | Language of the UI chrome (search, "On This Page", prev/next, theme toggle). Your MDX content is never translated. Unknown values fall back to `en`                       | `en` (default) or `pt-BR`                                                                        |
| `MDX_BASEURL`                         | Base URL for inlining relative images                                                                                                                                    | `http://localhost:60141`or `https://github.com/acme/my-project/raw/main/docs`         |
| `SOURCECODE_BASEURL`                  | Base URL for `sourcecode:` code path                                                                                                                                     | `https://github.com/acme/my-project/tree/main`                                          |
| `EDIT_BASEURL`                        | Base URL for displaying "Edit this page" URLs                                                                                                                            | `https://github.com/acme/my-project/edit/main/docs`                                   |
| `NEXT_PUBLIC_URL`                     | Final URL of the published website                                                                                                                                       | `https://acme.github.io/my-project`                                                     |
...
| `GITHUB`                              | Github URL                                                                                                                                                               | `https://github.com/acme/my-project`                                                    |
...
> [!TIP]
> When deployed on GitHub Pages, `MDX_BASEURL` will typically value something like `https://github.com/acme/my-project/raw/main/docs`, thanks to [`build.yml`](.github/workflows/build.yml) rule.
...
$ (
  ...
  export GITHUB=https://github.com/acme/my-project
